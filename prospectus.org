...
** /theories/ of emotion in biosensing - psychologists, designers, users
...
*** specific theories biosensing researchers have drawn on
**** honest signals
**** how that  ties in, or no, to theoreis fo emotion
...
**** and picards work tends to 'instrumentalize' people
***** patients are persons to be data-ified and understood or something like that
*** why non-designer's opinions matter
**** can phrase question - how people (versus designers) think about the mind/body connection /in terms of/ sensors & devices & interfaces they encounter
**** really poeple's ideas of mind/body connection will drive their sense of risk when it comes to wearables
...
**** we want to undrestand these beliefs, to understand disclosure
***** how open can we expect people to be 
***** how/why/when 
***** and how can we see their disclosure change over time

** TODO /case/ acm group experiment
*** TODO QUESTOIONS
*** CASE
**** vignette
**** two scenarios
...
*** WHAT WE LEARNED
<2016-02-18 Thu>
**** high hr = more trust,,.in adversarial condition
** /theory/ of signals, given and given off
*** THEORY
*** goffman
*** signals / 
** /case/ ubicomp etc lab experiment
*** QUESTIONS
**** indpendent effect of representation / biosignal
**** on interpersonal judgements / risk + uncertainty
*** CASE
**** lab-based iterated prisoner's dilemna
*** WHAT WE LEARNED
** TODO /theory/  - the role of suggestion & authority in sensing
**** neurohype
**** moodlight
** TODO /case/ ????
*** will flow cleanly out of ubicomp plans - no worries
*** maybe the tech probe???
*** HeH ??
