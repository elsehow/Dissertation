...
***** no hr info
*** WHAT WE LEARNED
**** heartrate interacts with social expectations to produce contextual meanings
***** no one effect of elevated heartrate on trust
**** "people" don't think heartrate means any one thing, even within conditions
***** heterogeneous interpretations in our pool
* strategies
