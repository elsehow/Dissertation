...
* Reading mind from heartrate :ARCHIVE:
...
* Talking to engineers about brain-computer interface :ARCHIVE:
# Utopia
...
* Who are you really? Probing engineers on authentication and the ground truth of identity :ARCHIVE:
